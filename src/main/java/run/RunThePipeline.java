...
public class RunThePipeline {
    ...
    public static void main(String[] args) {
        ...
        // BITFINEX
        ArrayList<CurrencyPair> binancePair = new  ArrayList<CurrencyPair>();
        binancePair.add(CurrencyPair.BTC_USD);
        /* binancePair.add(CurrencyPair.ETH_USD);
        binancePair.add(CurrencyPair.XRP_USD);
        binancePair.add(CurrencyPair.BCH_USD);
        how to add additional custom pairs?
        binancePair.add(new CurrencyPair("XTZ", "BTC"));*/
        allExchanges.add(new ExchangeConfiguration(BinanceStreamingExchange.class.getName(),"binance", binancePair));
	/*
        // BITSTAMP
